...
const ToolbarQuitButton: React.FC<ToolbarQuitButtonProps> = ({ avalon }) => {
  ...
  return (
    <>
      ...
      {dialog && (
        <div className={styles.overlay} onClick={() => setDialog(false)}>
          <div className={styles.dialog} onClick={(e) => e.stopPropagation()}>
            <div className={styles.card}>
              ...
              <div className={styles.actions}>
                <button onClick={quitButtonClicked} className={styles.primaryButton}>
                  {actionDescription}
                </button>
                <button onClick={() => setDialog(false)} className={styles.secondaryButton}>
                  Nevermind
                </button>
              </div>
            </div>
