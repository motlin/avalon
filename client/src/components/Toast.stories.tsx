...
export const LongMessage: Story = {
  args: {
    message: 'This is a much longer notification message that demonstrates how the toast component handles text wrapping and maintains proper spacing with multiple lines of content.',
    type: 'info',
    duration: 6000,
  },
  parameters: {
