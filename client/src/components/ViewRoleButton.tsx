      ...
      <div className={styles.bottomSheet}>
        {!avalon.isGameInProgress ? (
          ...
          <div className={styles.card}>
            ...
            <div className={styles.cardText}>
              <p>
                Your role is <span className={styles.fontWeightMedium}>{avalon.lobby.role.role.name}</span>.
              </p>
              <p>
                You are on the <span className={styles.fontWeightMedium}>{avalon.lobby.role.role.team}</span> team.
              </p>
              <p>{avalon.lobby.role.role.description}</p>
              {avalon.lobby.role.assassin && (
                <p>
                  You are also the <span className={styles.fontWeightMedium}>ASSASSIN</span>!
              ...
              {avalon.lobby.role.sees.length > 0 ? (
                <div>
                  <p>
                    You see <span className={styles.fontWeightBold}>{joinWithAnd(avalon.lobby.role.sees)}</span>.
                  </p>
                </div>
              ) : (
