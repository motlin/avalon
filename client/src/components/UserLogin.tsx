...
const UserLogin: React.FC<UserLoginProps> = ({ avalon }) => {
  ...
  return (
    <div className={`${styles.card} ${styles.welcome} ${styles.cyanLighten5}`}>
      <div className={`${styles.layout} ${styles.alignCenter} ${styles.justifyCenter} ${styles.column} ${styles.fillHeight}`}>
          ...
          {tab === 0 && (
            <div className={styles.tabItem}>
              {!emailSubmitted ? (
                ...
                <>
                  <div className={`${styles.card} ${styles.xs6} ${styles.md3} ${styles.blueGreyLighten4}`}>
